...
namespace SmartHomeApplication.ClientUWP
{
    ...
    sealed partial class App : Application
    {
        ...
        private static bool? lastInternetStatus;
        ...
        {
            if (lastInternetStatus.HasValue)
            {
                await ShowErrorMessage();
                return lastInternetStatus.Value;
            }

            NetworkInformation.NetworkStatusChanged += sender =>
            {
                ConnectionProfile connectionProfile = NetworkInformation.GetInternetConnectionProfile();
                lastInternetStatus = connectionProfile?.GetNetworkConnectivityLevel() == NetworkConnectivityLevel.InternetAccess;
            };

            ConnectionProfile connections = NetworkInformation.GetInternetConnectionProfile();
            bool internet = connections != null && connections.GetNetworkConnectivityLevel() == NetworkConnectivityLevel.InternetAccess;
            lastInternetStatus = internet;
            await ShowErrorMessage();
            return lastInternetStatus.HasValue && lastInternetStatus.Value;
        }

        private static async Task ShowErrorMessage()
        {
            if (!lastInternetStatus.Value)
            {
